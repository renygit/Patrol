 ...
 * 首页-推荐
 */
public class InfoOtherPresenter extends BasePresenter<InfoOtherView> {
    ...
    public void setCategory(String category) {
        LogUtils.e("setCategory : " + category);
        this.category = category;
    }

    public InfoOtherPresenter(InfoOtherView view) {
        super(view);
    }

    @Override
    public void loadData(boolean isRefresh) {
        addDisposable(ServiceHelper.getApi().getInfoList(category, pageSize, isRefresh ? 1 : page)
