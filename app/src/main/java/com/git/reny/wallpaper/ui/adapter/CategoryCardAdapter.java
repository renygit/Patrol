...
public class CategoryCardAdapter extends BaseQuickAdapter<CategoryBean, BaseViewHolder> {

    private int radius;

    public CategoryCardAdapter(@Nullable List<CategoryBean> data) {
        super(R.layout.item_card_category, data);
